...
function setFixed(){if(!isFixed()){spacer.css({'display':target.css('display'),'width':target.outerWidth(!0),'height':target.outerHeight(!0),'float':target.css('float')});cssOptions={'z-index':base.options.zIndex,'position':'fixed','top':base.options.bottom==-1?getMarginTop():'','bottom':base.options.bottom==-1?'':base.options.bottom,'margin-left':'0px'}
